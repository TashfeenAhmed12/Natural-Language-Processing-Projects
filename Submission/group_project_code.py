...
# -*- coding: utf-8 -*-
"""
Created on Sun Feb 11 19:13:52 2024
...
# -*- coding: utf-8 -*-
"""
Created on Sun Feb 11 19:27:50 2024
...
df = pd.read_excel("df_adding_clean_texts_POS_proportions_tfidf.xlsx")
df.head()

# Ensure the 'label' column is of a consistent data type
df['label'] = pd.to_numeric(df['label'], errors='coerce').fillna(0).astype(int)

# Selecting the features and the target variable
X = df[['NOUN_TFIDF', 'VERB_TFIDF', 'DET_TFIDF', 'ADJ_TFIDF', 'AUX_TFIDF', 'CCONJ_TFIDF', 'PART_TFIDF']]
y = df['label']
...
y_prob = clf.predict_proba(X_test)[:, 1]  # Probabilities for AUC calculation
...
print(f"F1 Score: {f1}")
#F1 Score: 0.6416243654822336
print(f"AUC: {auc}")
#AUC: 0.7019288948648488    
